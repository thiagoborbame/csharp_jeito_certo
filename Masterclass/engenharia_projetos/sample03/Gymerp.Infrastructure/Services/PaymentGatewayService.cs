...
namespace Gymerp.Infrastructure.Services
{
    public class PaymentGatewayService : IPaymentGatewayService
    {
            ...
            IConfiguration configuration)
        {
            ...
            _apiKey = _configuration["PagarMe:ApiKey"] ?? throw new ArgumentNullException("PagarMe:ApiKey");
            _apiUrl = _configuration["PagarMe:ApiUrl"] ?? throw new ArgumentNullException("PagarMe:ApiUrl");
        }
